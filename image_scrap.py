...
def imagedown(url, folder):
    ...
    for image in images:
        name = image['alt']
        # name = "img"+str(image)
        link = "https://www.freewalldownload.com"+image['src']
        # link = image['src']
...
imagedown('https://www.freewalldownload.com/search/face/', 'dataset/without_mask')
# imagedown('https://www.shutterstock.com/search/frontal+face', 'bratislava1')
